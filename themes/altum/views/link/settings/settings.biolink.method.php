        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a
                        href="#"
                        class="dropdown-item <?= ((in_array($key, ['soundcloud', 'spotify']) && !$this->user->plan_settings->music_embeds) || in_array($key, ['youtube', 'vimeo', 'twitch', 'tiktok']) && !$this->user->plan_settings->video_embeds) ? 'container-disabled' : null ?>"
                        data-toggle="modal"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="update_biolink" action="" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="custom-control custom-switch mr-3 mb-3 <?= !$this->user->plan_settings->verified ? 'container-disabled': null ?>">
                                <input
                                        type="checkbox"
                            ...
                            <div class="<?= !$this->user->plan_settings->custom_backgrounds ? 'container-disabled': null ?>">
                            ...
                            <div class="collapse" id="branding_container">
                                ...
                                <div class="<?= !$this->user->plan_settings->custom_branding ? 'container-disabled': null ?>">
                                    <div class="form-group">
                            ...
                            <div class="collapse" id="analytics_container">
                                <div class="<?= !$this->user->plan_settings->google_analytics ? 'container-disabled': null ?>">
                                    <div class="form-group">
                            ...
                            <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#experience_container" aria-expanded="false" aria-controls="experience_container">
                                <?= $this->language->link->settings->experience ?>
                            </button>
                          ...
                          if(property_exists($data->link->settings, 'experience')){ 
                                ...
                                ?>
                                    <div class="form-group autocomplete">
                                        ...
                                        <input id="myInput" onclick="autofill(this)" type="text" class="form-control " name="experience_company[]" value="<?= $data->link->settings->experience->company[$i] ?? '' ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="experience_position" type="text" class="form-control" name="experience_position[]" value="<?= $data->link->settings->experience->position[$i] ?? '' ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="experience_start" type="date" class="form-control" name="experience_start_date[]" value="<?= $data->link->settings->experience->start[$i] ?? '' ?>" />
                                        <small class="text-muted"><?= $this->language->link->settings->experience_start ?></small>
                                    </div>

                                    <div class="form-group">
                                        <label><i class="fab fa-fw fa-google fa-sm mr-1"></i> <?= $this->language->link->settings->experience_end ?></label>
                            ...
                            <?php } }else{ ?>
                                <div class="form-group autocomplete">
                                    ...
                                    <div class="form-group">
                                        <label><i class="fab fa-fw fa-google fa-sm mr-1"></i> <?= $this->language->link->settings->experience_start ?></label>
                                        <input id="experience_start" type="date" class="form-control" name="experience_start_date[]" value="" />
                                        <small class="text-muted"><?= $this->language->link->settings->experience_start ?></small>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label><i class="fab fa-fw fa-google fa-sm mr-1"></i> <?= $this->language->link->settings->experience_end ?></label>
                                        <input id="experience_end" type="date" class="form-control" name="experience_end_date[]" value="" />
                                        <small class="text-muted"><?= $this->language->link->settings->experience_end ?></small>
                                    </div>
                            <?php } ?>
                            ...
                            <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#education_container" aria-expanded="false" aria-controls="seo_container">
                                <?= $this->language->link->settings->education ?>
                            </button>
                        ...
                        //    print_r($data->link->settings->education);
                            if($data->link->settings->education->course !=  ""){ 
                                ...
                                ?>
                                    <div class="form-group">
                                        ...
                                        <input id="education_course" onclick="autofillEdu(this)" type="text" class="form-control" name="education_course[]" value="<?= $data->link->settings->education->course[$i] ?? '' ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="education_univ" type="text" class="form-control" name="education_univ[]" value="<?= $data->link->settings->education->univ[$i] ?? '' ?>" />
                            ...
                            <div class="collapse" id="seo_container">
                                <div class="<?= !$this->user->plan_settings->seo ? 'container-disabled': null ?>">
                            ...
                            <div class="collapse" id="utm_container">
                                <div class="<?= !$this->user->plan_settings->utm ? 'container-disabled': null ?>">
                            ...
                            <div class="collapse" id="socials_container">
                                <div class="<?= !$this->user->plan_settings->socials ? 'container-disabled': null ?>">
                                    <div class="form-group">
                            ...
                            <div class="collapse" id="fonts_container">
                                <div class="<?= !$this->user->plan_settings->fonts ? 'container-disabled': null ?>">
            ...
            <div class="tab-pane fade <?= isset($_GET['tab']) && $_GET['tab'] == 'links'? 'show active' : null ?>" id="links" role="tabpanel" aria-labelledby="links-tab">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="col-6 col-md-6">
                                        <div class="d-flex flex-column">
                                            ...
                                            >
                                                <strong><?= in_array($row->subtype, ['spotify', 'youtube', 'vimeo', 'tiktok', 'twitch', 'soundcloud', 'text', 'mail']) ? $this->language->link->biolink->{$row->subtype}->name : $row->settings->name ?></strong>
                                            </a>
                                    ...
                                    <div class="col-2">
                                        <?php if(!in_array($row->subtype, ['mail', 'text', 'youtube', 'vimeo', 'tiktok', 'twitch', 'spotify', 'soundcloud'])): ?>
                ...
                <?php else: ?>
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center mt-5">
                        <img src="<?= SITE_URL . ASSETS_URL_PATH . 'images/no_data.svg' ?>" class="col-10 col-md-8 col-lg-6 mb-4" alt="<?= $this->language->link->links->no_data ?>" />
