            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div id="plan_settings" style="display: none">
                        ...
                        <div class="custom-control custom-switch mb-3">
                        <input id="education" name="education" type="checkbox" class="custom-control-input" <?= @$data->user->plan->settings->education ? 'checked="checked"' : null ?>>
                    ...
                    <div class="custom-control custom-switch mb-3">
                        <input id="experience" name="experience" type="checkbox" class="custom-control-input" <?= @$data->user->plan->settings->experience ? 'checked="checked"' : null ?>>
                    ...
                    <div class="custom-control custom-switch mb-3">
                        ...
                        <div class="custom-control custom-switch mb-3">
                            <input id="music_embeds" name="music_embeds" type="checkbox" class="custom-control-input" <?= $data->user->plan->settings->music_embeds ? 'checked="checked"' : null ?>>
                        ...
                        <div class="custom-control custom-switch mb-3">
                            <input id="video_embeds" name="video_embeds" type="checkbox" class="custom-control-input" <?= $data->user->plan->settings->video_embeds ? 'checked="checked"' : null ?>>
...
<script>
    ...
    $('[name="plan_expiration_date"]').datepicker({
        ...
        onSelect: check_plan_expiration_date
    });
