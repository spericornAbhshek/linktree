    ...
    TagsInput.prototype = {
        ...
        add: function(item, dontPushVal, options) {
            ...
            if (this.isInit) {
                ...
                // $('#biolink_preview_iframe').contents().find('.skills_container').append("&nbsp;<span class=" + item + " style = 'border: solid; border-radius: 5px;'> &nbsp;" + item + "&nbsp; </span>&nbsp;")
            }
        },
        ...
        remove: function(item, dontPushVal, options) {
            ...
            $('#biolink_preview_iframe').contents().find("." + item).remove()
        },
